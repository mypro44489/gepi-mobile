...
use api\modules\v1\models\Abscence;
 ...
 */
class EmploidutempsController extends ActiveController {

    public $modelClass = 'api\modules\v1\models\Emploidutemps';
...
$command = $connection->createCommand('SELECT emploidutemps.*, periode.HEUREPERIODE, classe.LIBELLECLASSE, matiere.LIBELLEMATIERE FROM emploidutemps JOIN classe ON (emploidutemps.IDCLASSE=classe.ID) JOIN periode ON (emploidutemps.IDPERIODE=periode.ID) JOIN matiere ON (emploidutemps.IDMATIERE=matiere.ID)');
